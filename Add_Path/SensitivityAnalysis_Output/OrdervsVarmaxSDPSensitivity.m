function varmax=OrdervsVarmaxSDPSensitivity(A,As,H,mu,n,AnaMol,Arow,Norm,Upparam,Lwparam)
    ...
    info
    varmax=y(nchoosek(mu+n+1,mu+1),1)*Norm(1,AnaMol)^2; % Maximum 
